...
document.addEventListener("DOMContentLoaded", () => {
    ...
    k.scene("intro", ()=>{
        const s = k.add([k.pos(k.center()),k.text("Made by Minamotion\nMade with Kaboom.js", {align: "center", width: k.width()}),k.anchor("top"),k.color([63,72,204]),{disappear:false,appear:true},k.opacity(0),k.scale(1)])
        s.onUpdate(()=>{
